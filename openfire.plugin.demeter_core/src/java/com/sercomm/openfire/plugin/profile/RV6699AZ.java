...
public class RV6699AZ implements IProfile
{
    private static String MAIN_CONTAINER_NAME = "SmartHome";
    ...
    throws Throwable
    {
        ...
        Map<?,?> dataModel = UbusManager.getInstance().fire(
            ...
            mac, 
            "get", 
            UbusUtil.buildPath("Services", "Management", "LCM", "ExecutionEnvironments", MAIN_CONTAINER_NAME, "Packages"),
            XStringUtil.BLANK, 
            10 * 1000L);
