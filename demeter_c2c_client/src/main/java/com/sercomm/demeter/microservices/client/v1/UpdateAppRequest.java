...
public class UpdateAppRequest extends AbstractRequest
{    
    ...
    public UpdateAppRequest withOriginatorId(String originatorId)
    {
        super.originatorId = originatorId;
        return this;
    }
    
    public UpdateAppRequest withNodeName(String nodeName)
    {
        this.nodeName = nodeName;
        return this;
    }
    
    public UpdateAppRequest withRequestContents(
            String appId, 
            String versionId, 
            String taskId)
    {
